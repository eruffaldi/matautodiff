    ...
    methods
        ...
        function autodiff(this)
            ...
            mautodiff(this);
                ...
                % autodiff function producing an adjoint
        function xautodiff(this)
            if isempty(this.avalue)
                update(this);
            end
            resetadjoint(this,0);
            this.aadjoint = matexp(eye(numel(this.avalue))); 
            xmautodiff(this);
        end
